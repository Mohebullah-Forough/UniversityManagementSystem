...
<div class="fluid">
	<div class="row bg-dark bg-gradient">
		...
		<div class="col-8 my-2 mx-auto text-white">
			<p class="text-center fs-3">Edit Course</p>
			<hr class="border border-warning border-2 opacity-50">
			<form action="<%=request.getContextPath()%>/staffs/updateCourse" method="POST">
			
			<input type="hidden" name="courseId"  class="form-control" id="courseId" value="${courseInfo.courseId}">
				<div class="row mb-3">
					<div class="col-md-6">
						<label for="courseCode" class="form-label">Course Code</label> <input
							type="text" name="courseCode" class="form-control" id="courseCode" required value="${courseInfo.courseCode }">
					</div>
					<div class="col-md-6">
						<label for="courseName" class="form-label">Course Name</label> <input
							type="text" name="courseName" class="form-control" id="courseName" required value="${courseInfo.courseName}">
					</div>
				</div>
				...
				<div class="mb-3">
					<label for="department" class="form-label">Course Department</label> <select
						...
						<option value="${courseInfo.courseDeparment}" selected >${courseInfo.courseDeparment}</option>
				...
				<div class="mb-3">
					<label for="degree" class="form-label">Semester</label> <select
						...
						<option value="${courseInfo.courseSemester}" selected >${courseInfo.courseSemester}</option>
